...
export default function Home() {
    ...
    const pesanWhatsapp = async (e) => {
        ...
        let text = `Hai kak ARYO'S SELF STUDIO, saya ingin reservasi%0ANama%20%3A${nama}%0ANo%20hp%20%3A${noTelp}%0AInstagram%20%3A${email}%0ATgl%20booking%20%3A${tglPesan}%0AEstimasi%20waktu%20%3A${jadwalPesan}%0APaket%20%3A${pilih}%0ABackground%20%3A${begrond}%0ATambahan%20%3A${catatan}%0AApakah slot tersebut tersedia?%0Aterimakasih`
